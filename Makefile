...
%-ubuntu18.04:
	$(DOCKER) build --build-arg VERSION_ID="18.04" \
                        ...
                        -t "naturlich/nvidia-docker2-ubuntu:18.04-docker$*" -f Dockerfile.ubuntu .
...
17.12.1-ubuntu18.04:
	$(DOCKER) build --build-arg VERSION_ID="18.04" \
                        ...
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "naturlich/nvidia-docker2-ubuntu:18.04-docker17.12.1" -f Dockerfile.ubuntu .
...
%-ubuntu16.04:
	$(DOCKER) build --build-arg VERSION_ID="16.04" \
                        ...
                        --build-arg PKG_VERS="$(VERSION)+docker$*" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "naturlich/nvidia-docker2-ubuntu:16.04-docker$*" -f Dockerfile.ubuntu .
...
1.13.1-ubuntu16.04:
	$(DOCKER) build --build-arg VERSION_ID="16.04" \
                        ...
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "naturlich/nvidia-docker2-ubuntu:16.04-docker1.13.1" -f Dockerfile.ubuntu .
...
1.12.6-ubuntu16.04:
	$(DOCKER) build --build-arg VERSION_ID="16.04" \
                        ...
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "naturlich/nvidia-docker2-ubuntu:16.04-docker1.12.6" -f Dockerfile.ubuntu .
...
%-ubuntu14.04:
	$(DOCKER) build --build-arg VERSION_ID="14.04" \
                        ...
                        --build-arg PKG_VERS="$(VERSION)+docker$*" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "naturlich/nvidia-docker2-ubuntu:14.04-docker$*" -f Dockerfile.ubuntu .
...
%-debian9:
	$(DOCKER) build --build-arg VERSION_ID="9" \
                        ...
                        --build-arg PKG_VERS="$(VERSION)+docker$*" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "naturlich/nvidia-docker2/debian:9-docker$*" -f Dockerfile.debian .
...
17.03.2-debian9:
	$(DOCKER) build --build-arg VERSION_ID="9" \
                        ...
                        --build-arg PKG_VERS="$(VERSION)+docker17.03.2" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "naturlich/nvidia-docker2/debian:9-docker17.03.2" -f Dockerfile.debian .
...
%-debian8:
	$(DOCKER) build --build-arg VERSION_ID="8" \
                        ...
                        --build-arg PKG_VERS="$(VERSION)+docker$*" \
                        --build-arg PKG_REV="$(PKG_REV)" \
                        -t "naturlich/nvidia-docker2/debian:8-docker$*" -f Dockerfile.debian .
...
%.ce-centos7:
	$(DOCKER) build --build-arg VERSION_ID="7" \
                        ...
                        -t "naturlich/nvidia-docker2/centos:7-docker$*.ce" -f Dockerfile.centos .
...
%-centos7:
	$(DOCKER) build --build-arg VERSION_ID="7" \
                        ...
                        -t "naturlich/nvidia-docker2/centos:7-docker$*" -f Dockerfile.centos .
...
%.ce-amzn2:
	$(DOCKER) build --build-arg VERSION_ID="2" \
                        ...
                        -t "naturlich/nvidia-docker2/amzn:2-docker$*" -f Dockerfile.amzn .
...
%.ce-amzn1:
	$(DOCKER) build --build-arg VERSION_ID="1" \
                        ...
                        -t "naturlich/nvidia-docker2/amzn:1-docker$*" -f Dockerfile.amzn .
